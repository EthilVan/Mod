...
public class EntityOtherPlayerMP extends EntityPlayer
{
    ...
    public EntityOtherPlayerMP(World par1World, String par2Str, String par3Str)
    {
        super(par1World);
        this.username = par2Str;
        this.headName = par3Str;
        this.yOffset = 0.0F;
        this.stepHeight = 0.0F;

        if (par2Str != null && par2Str.length() > 0)
        {
            this.skinUrl = "http://skins.minecraft.net/MinecraftSkins/" + StringUtils.stripControlCodes(this.username) + ".png";
        }
