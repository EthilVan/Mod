...
public class BlockTorch extends Block
{
    ...
    private boolean canPlaceTorchOn(World par1World, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            return var5 == Block.fence.blockID || var5 == Block.netherFence.blockID || var5 == Block.glass.blockID || var5 == Block.cobblestoneWall.blockID || var5 == mod_Ethilvan.coloredGlass.blockID || var5 == mod_Ethilvan.sandStoneWall.blockID || var5 == mod_Ethilvan.brickWall.blockID || var5 == mod_Ethilvan.stoneBrickWall.blockID;
        }
    }
