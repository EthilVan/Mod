...
public class GuiMainMenu extends GuiScreen
{
	...
	public void initGui()
	{
		...
		this.controlList.add(new GuiButton(3, width / 2 - 100, var4 + 86, 98, 20, var2.translateKey("menu.mods")));

		this.controlList.add(new GuiButton(6, width / 2 - 100, var4 + 14, var2.translateKey("Connexion à Ethil Van...")));
		this.controlList.add(new GuiButton(7, width / 2 - 100, var4 - 10, 98, 20, var2.translateKey("EthilVan.fr")));
		this.controlList.add(new GuiButton(8, width / 2 + 2 , var4 - 10, 98, 20, var2.translateKey("Carte dynamique")));
		//this.controlList.add(new GuiButton(9, this.width / 2 + 2, var4 + 48, 98, 20, "Mods")); -- I will change his location
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		GL11.glPopMatrix();
		String var9 = "Minecraft 1.4.7 pour EthilVan";
