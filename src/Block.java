...
public class Block
{
    ...
    static
    {
        ...
        //Item.itemsList[woolSingleSlab1.blockID] = (new ItemWoolSlab(woolSingleSlab1.blockID - 256, woolSingleSlab1, woolDoubleSlab1, false)).setItemName("woolSlab");
        //Item.itemsList[woolDoubleSlab1.blockID] = (new ItemWoolSlab(woolDoubleSlab1.blockID - 256, woolSingleSlab1, woolDoubleSlab1, true)).setItemName("woolSlab");
