...
public class GuiListControls extends GuiList {
	...
	public GuiListControls(Minecraft minecraft, GuiControls guiControls, GameSettings gamesettings) {
		super(minecraft, guiControls.width + 80, guiControls.height, guiControls.height / 6 - 8, guiControls.height / 6 + 168 - 8, 24);
